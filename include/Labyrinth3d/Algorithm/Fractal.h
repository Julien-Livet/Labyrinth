#ifndef LABYRINTH3D_ALGORITHM_FRACTAL_H
#define LABYRINTH3D_ALGORITHM_FRACTAL_H
...
namespace Labyrinth3d
{
    namespace Algorithm
    {
        ...
        class Fractal
        {
            ...
            private:
                template <class URNG>
                inline std::array<std::array<bool, 2>, 3> expandPattern(URNG& g, bool verticalDirection,
...
/**
template <class URNG>
void Labyrinth3d::Algorithm::Fractal::operator()(URNG& g, SubGrid const& subGrid,
...
template <class URNG>
inline std::array<std::array<bool, 2>, 3> Labyrinth3d::FractalAlgorithm::expandPattern(URNG& g, bool verticalDirection,
                                                                                       bool startWall, bool centerWall)
{
...
**/
#endif // LABYRINTH3D_ALGORITHM_FRACTAL_H
