...
template <class URNG>
void Labyrinth2d::Algorithm::Kruskal::operator()(URNG& g, SubGrid const& subGrid,
...
template <class URNG>
void Labyrinth2d::Algorithm::Kruskal::recursiveGeneration_(URNG &g, SubGrid const& subGrid,
                                                           std::function<void(std::chrono::milliseconds)> const& sleep,
                                                           size_t cycleOperations, std::chrono::milliseconds const& cyclePause,
                                                           std::chrono::milliseconds const* timeout)
{
    ...
    {
        grid.emplace_back(i);
        possiblePositions.emplace_back(std::make_pair(i / columns * 2 + 1, (i % columns) * 2 + 1));
    }
...
template <class URNG>
void Labyrinth2d::Algorithm::Kruskal::loopGeneration_(URNG &g, SubGrid const& subGrid,
                                                      std::function<void(std::chrono::milliseconds)> const& sleep,
                                                      size_t cycleOperations, std::chrono::milliseconds const& cyclePause,
                                                      std::chrono::milliseconds const* timeout)
{
